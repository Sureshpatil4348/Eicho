...
import { Avatar, Box, Button, FormControlLabel, Grid, Menu, MenuItem, TextField } from "@mui/material";
...
import PorfolioMenu from "@renderer/assets/images/portfolio-menu.svg";
...
import ManagmentBox from "@renderer/assets/images/managment-box.png";
        ...
        <div className="dashboard_container">
          ...
          <div className="right_header">
            <div className="notification">
              <Link to="/"><img src={Notification} /></Link>
            </div>
            <PopupState variant="popover" popupId="demo-popup-menu">
              {(popupState) => (
                <>
                  ...
                  <Menu {...bindMenu(popupState)} className='theme-menu-dropdown-s2'
                    anchorOrigin={{
                      vertical: 'bottom',
                      horizontal: 'right',
                    }}
