                ...
                <Box sx={{ position: "relative" }}>
                  <Box
                    sx={{
                      ...
                      borderRadius: 4,
                      background:
                        "linear-gradient(to right, #dc2626 0%, #dc2626 45.27%, #ef4444 45.27%, #ef4444 54.36%, #f97316 54.36%, #f97316 63.45%, #f59e0b 63.45%, #f59e0b 72.54%, #8b5cf6 72.54%, #8b5cf6 81.63%, #3b82f6 81.63%, #3b82f6 90.72%, #10b981 90.72%, #10b981 100%)",
                      position: "relative",
                    }}
                  />
