...
const ConnectWallet: React.FunctionComponent<{ closeModal: () => void }> = ({ closeModal }) => {
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="row">
                    ...
                    <div className="col-md-12 form-group">
                        ...
                        <div className="field">
                            <input type='text' className='form-control' placeholder='login id..' {...register('login')} />
                        </div>
                    ...
                    <div className="col-md-12 form-group">
                        <label>Server</label>
                        <div className="field">
                            <input type='text' className='form-control' placeholder='Server name' {...register('server')} />
                        </div>
